...
<body style="background-image:url(<%=path%>/images/background.jpg)">
	...
	<div class="container marketing">
		...
		<div class="row" style="width:100%;">
			<div style="width:90%; margin:0 auto; float:none;">
				<s:action name="showRandomMenu" executeResult="true"/>
					...
					<div class="col-lg-4" style="width:33.3333333%; float:left; margin-top:20px;">
						...
						<p>
							<a class="btn btn-default"
								href="addToCart?menuid=<s:property value="#menu.menuid"/>&quantity=1"
